...

{
  ...
  "accessory_indices": [],
  "reason": "날씨 기반 — (오늘 체감온도·날씨 상태를 근거로 이 옷을 선택한 이유를 구체적으로. 예: 기온, 바람, 습도 등. 이모지 적극 활용)\\n외출 목적 — (선택한 활동·자리에 이 코디가 왜 어울리는지 분위기·격식 수준까지 설명. 이모지 적극 활용)\\n퍼스널 컬러 — (추천한 옷의 색상이 퍼스널 컬러와 어떻게 잘 맞는지 색상 이름 언급하며 구체적으로. 이모지 적극 활용)\\n스타일 선호도 — (좋아하는 스타일을 어떻게 반영했는지, 또는 싫어하는 스타일을 어떻게 피했는지. 이모지 적극 활용)",
  "tips": ["실제로 따라 할 수 있는 구체적인 스타일링 팁. 이모지 적극 활용 (예: 소매 걷기, 레이어링 방법, 색상 포인트 주는 법 등)", "착용감·활동성·날씨 대응 관련 실용적인 팁. 이모지 적극 활용"]
}`
